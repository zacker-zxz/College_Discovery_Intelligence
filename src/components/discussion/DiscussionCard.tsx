    ...
    <Card hoverable className="border-slate-200">
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-2 flex-1">
          ...
          <Link
            href={`/discussions/${id}`}
            className="font-bold text-slate-900 text-base leading-snug hover:text-blue-600 transition-colors block"
          >
            {title}
          </Link>

          <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed">{body}</p>
        ...
        {/* Stats Column */}
        <div className="flex flex-col items-end justify-center gap-2 bg-slate-50 p-3 rounded border border-slate-100 min-w-[90px] text-center">
          ...
          <div className="text-[11px] text-slate-400 flex items-center gap-1 pt-1 border-t border-slate-200/60 w-full justify-center">
