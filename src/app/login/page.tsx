      ...
      <div className="glass-card rounded-3xl border border-slate-200/80 shadow-elevated overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-8 md:p-10 bg-white/90 dark:bg-slate-900/90 flex flex-col justify-between space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-xs">Enter your registered email and password</p>
          </div>
          ...
          {demoEnabled && (
            <div className="bg-slate-50 dark:bg-slate-800/60 p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-700 space-y-2">
              <span className="text-[11px] font-bold text-slate-700 dark:text-slate-300 block text-center">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button
                  ...
                  className="text-xs bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg"
                >
                  <UserCheck className="w-3.5 h-3.5 mr-1 text-blue-600 dark:text-blue-400" /> Demo Student
                </Button>
                <Button
                  variant="outline"
                  size="sm"
                  ...
                  className="text-xs bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg"
                >
                  <Sparkles className="w-3.5 h-3.5 mr-1 text-purple-600 dark:text-purple-400" /> Demo Admin
                </Button>
              </div>
            </div>
          )}
